...
public class SetPractice2 {
    public static void main(String[] args) {
        ...
        Set<String> set1=new HashSet<>(Arrays.asList(arr)); // all the duplicated elements are gone
        System.out.println(set1);

        arr= set1.toArray(new String[0]); // to array method is used to convert to array

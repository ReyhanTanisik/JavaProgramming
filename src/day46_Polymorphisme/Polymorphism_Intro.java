package day46_Polymorphisme;

import day43_Abstraction.employeeTask.*;
import day44_Abstract_InterfaceIntro.animalTask.Animal;
import day44_Abstract_InterfaceIntro.animalTask.Cat;
import day44_Abstract_InterfaceIntro.animalTask.Dog;
import day44_Abstract_InterfaceIntro.animalTask.Playable;
...
public class Polymorphism_Intro {
    ...
    public static void main(String[] args) {
        ...
        Object[] array = {str, n1, n2, r1, new day45_Abstraction.shapeTask.Circle(4) , new day45_Abstraction.shapeTask.Square(7)};
        ...
        Shape shape = new day45_Abstraction.shapeTask.Circle(5);
        shape.area();
